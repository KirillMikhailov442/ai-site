...
## 🔧 Configuration
To run the application, you need an OpenAI API key. Get it from [platform.openai.com](https://platform.openai.com/api-keys) and add it to the environment variables.
